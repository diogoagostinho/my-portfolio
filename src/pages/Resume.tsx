        ...
        <div className="work__content">
          <div className="work-left">
            <div className="work__header">
              <h1>Resume</h1>
              <h2>See where i’ve studied/worked and all of my certificates</h2>
            </div>
              ...
              <div className="work__dividers">
                ...
                <div className="resume-block">
                  ...
                  <p>
                    ...
                    interaction with any kind of technical work. Amongst all the
                    studies, I learned C, C#, PHP and JavaScript.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="work__dividers">
                <div className="resume-block">
                  ...
                  <p>
                    ...
                    install a MFP Xerox device, after the analysis, the printer
                    is installed in the client's office. The other side of the
                    job involves technical support (helpdesk) through Anydesk
                    and/or TeamViewer.
                  </p>
                </div>
                <div className="resume-block">
