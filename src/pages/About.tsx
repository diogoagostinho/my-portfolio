              ...
              <div className="about-left">
                <Fade delay={100}>
                  ...
                  <div className="about__catch">
                    <p className="small">
                      “Hello! I’m Diogo Agostinho, and i’ve been teaching myself
                      how to code for over a year!”
                    </p>
                  </div>
                  <div className="about__info">
                    <p>
                      I'm a 21-year-old young man living in Portugal, currently
                      working, forever a student. Hoping to work freelance or on
                      a contract basis as a web developer.
                    </p>
                    <p>
